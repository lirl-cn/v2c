...
var _sfc_render = function render() {
  ...
  return _c("c-content-container", { staticClass: "lrl-table-plus-container", attrs: { "no-padding": "" }, scopedSlots: _vm._u([_vm.showHeader ? { key: "header", fn: function() {
    return [!_vm.hideSearch ? _c("cn-form", { attrs: { "layout": _vm.searchLayout, "data": _vm.searchColumns, "actionRef": _vm.setSearchRef, "columns": _vm.searchGrid }, scopedSlots: _vm._u([_vm._l(_vm.searchColumns.filter(
