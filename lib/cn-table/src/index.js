...
const _sfc_main = {
      ...
      return __async(this, null, function* () {
        ...
        if (this.request) {
          ...
          try {
            ...
            response = (yield (_b = this.formatResponse) == null ? void 0 : _b.call(this, error, "error")) || DEFAULT_RESPONSE_DATA;
            current = 1;
          }
          this.ownLoading = false;
  ...
  computed: {
    __setting() {
      var _a;
      return ((_a = this.$CN_V2C_TABLE_CONFIG) == null ? void 0 : _a.setting) || this.setting;
    },
    __pagination() {
      return typeof this.pagination === "object" ? __spreadValues(__spreadProps(__spreadValues({}, this.ownPagination), {
        pageSizeOptions: this.pageSizeOptions
      }), this.pagination) : __spreadValues({ pageSizeOptions: this.pageSizeOptions }, this.ownPagination);
    },
