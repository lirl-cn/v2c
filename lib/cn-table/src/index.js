...
var _sfc_render = function render() {
  ...
  return _c("div", { ref: "cn-table--container", staticClass: "cn-table--container" }, [_vm.search ? _c("div", { class: ["cn-table-search-container", { "cn-table-search-inline-container": _vm.__searchType === "inline" }] }, [_c("cn-form", { ref: "search-table-search-form", attrs: { "data": _vm.ownSearchList, "layout": _vm.__searchType, "columns": _vm.__searchColumns }, scopedSlots: _vm._u([_vm._l(_vm.ownSearchList, function({ name }) {
    ...
    return [_c("a", { on: { "click": function($event) {
      var _a3, _b2;
      (_b2 = (_a3 = _vm.rowSelection) == null ? void 0 : _a3.onBatchDelete) == null ? void 0 : _b2.call(_a3, _vm.selectedRows);
    } } }, [_vm._v(_vm._s(((_a2 = _vm.rowSelection) == null ? void 0 : _a2.batchDeleteText) || ((_c2 = (_b = _vm.$CN_V2C_TABLE_CONFIG) == null ? void 0 : _b.rowSelection) == null ? void 0 : _c2.batchDeleteText) || "\u6279\u91CF\u5220\u9664"))]), _c("a", { on: { "click": function($event) {
      var _a3, _b2;
      (_b2 = (_a3 = _vm.rowSelection) == null ? void 0 : _a3.onBatchDownload) == null ? void 0 : _b2.call(_a3, _vm.selectedRows);
  ...
  })], 2)], 1), _vm.showPagination && (_vm.dataSource || _vm.ownDataSource).length !== 0 ? _c("div", { staticClass: "cn-table-pagination-container" }, [_c("cn-el-pagination", { attrs: { "onChange": _vm.handleTableChange, "current": _vm.__pagination.current, "page-size": _vm.__pagination.pageSize, "pageSizeOptions": _vm.pageSizeOptions, "total": _vm.__pagination.total } })], 1) : _vm._e()]);
};
