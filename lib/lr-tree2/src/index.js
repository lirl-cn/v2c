...
var _sfc_render = function render() {
  ...
  return _c("div", { ref: "containerRef", staticClass: "lr-tree-select--container2" }, [_c("div", { ref: "contentRef", staticClass: "lr-tree-select-container", style: `--lr-tree-bg-color: ${_vm.backgroundColor}; --lr-tree-border-color: ${_vm.borderColor};` }, [_c("div", { staticClass: "lr-tree-select-e2", style: { minWidth: _vm.canvasMinWidth } }), _c("div", { ref: "canvasRef", staticClass: "lr-tree-select-canvas2", style: [
    _vm.scale ? { transform: `scale(${_vm.scaleValue})` } : void 0
  ] }, [_c("LrTreeNode2", { attrs: { "data": _vm.dataSource, "mode": _vm.mode, "arrow": _vm.arrow }, scopedSlots: _vm._u([{ key: "node", fn: function({ data }) {
    return [_vm._t("node", null, { "data": data })];
  } }], null, true) })], 1)]), _vm.scale ? _c("div", { staticClass: "lr-tree-select-operate2" }, [_c("span", { on: { "click": function($event) {
...
const LrTree2 = __component__.exports;
module.exports = LrTree2;
