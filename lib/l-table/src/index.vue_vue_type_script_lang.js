...
const _sfc_main = vue.defineComponent({
  ...
  methods: {
    ...
    formatValue(record, dataIndex, valueType, render) {
      ...
      switch (valueType) {
        case "date": {
          return dayjs__default.default(Number(record[dataIndex])).format("YYYY-MM-DD");
        }
        case "date-time": {
          return dayjs__default.default(Number(record[dataIndex])).format("YYYY-MM-DD HH:mm:ss");
        }
        default: {
