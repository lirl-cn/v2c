...
var _sfc_render = function render() {
  ...
  return _c("div", { ref: "cn-table--container", staticClass: "cn-table--container" }, [_vm.search ? _c("div", { class: [
    ...
    } } }, [_vm._v(_vm._s(((_b2 = _vm.rowSelection) == null ? void 0 : _b2.batchDeleteText) || ((_d = (_c3 = _vm.$CN_V2C_TABLE_CONFIG) == null ? void 0 : _c3.rowSelection) == null ? void 0 : _d.batchDeleteText) || "\u6279\u91CF\u5220\u9664"))]) : _vm._e(), ((_e = _vm.rowSelection) == null ? void 0 : _e.onBatchDownload) ? _c("a", { on: { "click": function($event) {
      var _a3, _b3;
  ...
  })], 2)], 1), _vm.pagination !== false && (_vm.dataSource || _vm.ownDataSource).length !== 0 ? _c("div", { staticClass: "cn-table-pagination-container" }, [_c("cn-el-pagination", { attrs: { "onChange": _vm.handleTableChange, "current": _vm.__pagination.current, "page-size": _vm.__pagination.pageSize, "pageSizeOptions": (_c2 = _vm.__pagination) == null ? void 0 : _c2.pageSizeOptions, "total": _vm.__pagination.total } })], 1) : _vm._e()]);
};
