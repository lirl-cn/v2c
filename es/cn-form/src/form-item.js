...
var _sfc_render = function render() {
  ...
  return _c("el-form-item", _vm._b({ attrs: { "label": _vm.title, "prop": _vm.name } }, "el-form-item", _vm.formItemProps, false), [_vm.type === "switch" ? _c("el-switch", _vm._b({ model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    ...
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "week" ? _c("el-date-picker", _vm._b({ attrs: { "format": "yyyy-MM", "value-format": "yyyy-MM-dd HH:mm:ss", "type": "week", "placeholder": _vm.placeholder || "\u9009\u62E9\u661F\u671F" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "date-month" ? _c("el-date-picker", _vm._b({ attrs: { "format": "yyyy-MM", "value-format": "yyyy-MM-dd HH:mm:ss", "type": "month", "placeholder": _vm.placeholder || "\u9009\u62E9\u6708\u4EFD" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "date-year" ? _c("el-date-picker", _vm._b({ attrs: { "format": "yyyy", "value-format": "yyyy-MM-dd HH:mm:ss", "type": "year", "placeholder": _vm.placeholder || "\u9009\u62E9\u5E74\u4EFD" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
    ...
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "monthrange" || _vm.type === "month-range" ? _c("el-date-picker", _vm._b({ attrs: { "type": "monthrange", "format": "yyyy-MM-dd", "value-format": "yyyy-MM-dd HH:mm:ss", "range-separator": _vm.separator || "\u81F3", "start-placeholder": _vm.startPlaceholder || "\u5F00\u59CB\u6708\u4EFD", "end-placeholder": _vm.endPlaceholder || "\u7ED3\u675F\u6708\u4EFD" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
