...
var _sfc_render = function render() {
  ...
  return _c("el-form-item", _vm._b({ attrs: { "label": _vm.title, "prop": _vm.name } }, "el-form-item", _vm.formItemProps, false), [_vm.type === "switch" ? _c("el-switch", _vm._b({ model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    ...
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "date-month" || _vm.type === "month" ? _c("el-date-picker", _vm._b({ attrs: { "format": "yyyy-MM", "value-format": "yyyy-MM-dd HH:mm:ss", "type": "month", "placeholder": _vm.placeholder || "\u9009\u62E9\u6708\u4EFD" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
  }, expression: "formModel[name]" } }, "el-date-picker", _vm.fieldItemProps, false)) : _vm._e(), _vm.type === "date-year" || _vm.type === "year" ? _c("el-date-picker", _vm._b({ attrs: { "format": "yyyy", "value-format": "yyyy-MM-dd HH:mm:ss", "type": "year", "placeholder": _vm.placeholder || "\u9009\u62E9\u5E74\u4EFD" }, on: { "change": _vm.onChange }, model: { value: _vm.formModel[_vm.name], callback: function($$v) {
    _vm.$set(_vm.formModel, _vm.name, $$v);
