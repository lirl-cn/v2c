...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    calcIndex(index) {
      if (typeof this.showIndex === "function") {
        return this.showIndex({
          ...
          text: (this.dParams[this._currentKey] - 1) * this.dParams[this._pageSizeKey] + (index + 1)
        });
      }
      return (this.dParams[this._currentKey] - 1) * this.dParams[this._pageSizeKey] + (index + 1);
    },
    doLayout() {
      this.$nextTick(() => {
        var _a;
    ...
    selectableFun(record, index) {
      var _a, _b;
      return (_b = (_a = this.selectable) == null ? void 0 : _a.call(this, record, index)) != null ? _b : true;
    },
    onSelect(_, row) {
      var _a;
